 ...
 */
public class TestIndividualOutputChainingRuleEvaluator {
    ...
    public void test() {
        ...
        IndividualOutputChainingRuleEvaluator<Integer, Integer> individualOutputChainingRuleEvaluator =
                new IndividualOutputChainingRuleEvaluator<>("set1", sets);
